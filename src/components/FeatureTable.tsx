...
const FeatureTable: React.FC<FeatureTableProps> = ({ categoryId }) => {
  ...
  useEffect(() => {
    if (user && canAssignEngineer(user.role)) {
      apiClient
        .getEngineers()
        .then(setEngineers)
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-4 p-4 bg-gray-800 border border-gray-700 rounded-md shadow-md">
        <h3 className="text-sm font-medium text-gray-300 mb-2">Category Description:</h3>
                    ...
                    <td className="px-4 py-3 border-b-0 w-28">
                      <span
                        className={`px-2 py-1 rounded-full text-xs whitespace-nowrap ${
                          priorityColorMap[feature.priority]
                        }`}
                      >
                        {feature.priority}
                      </span>
                    ...
                    <td colSpan={5} className="px-4 py-3">
                      <div className="grid grid-cols-6 gap-4 text-xs">
                        <div className="col-span-2">
                          ...
                          <div
                            className="text-gray-400 max-h-16 overflow-auto"
                        ...
                        <div>
                          ...
                          <div
                            className="text-gray-300 max-h-16 overflow-auto"
                            title={feature.customerName}
                          >
                        ...
                        <div>
                          ...
                          <div
                            className="text-gray-400 max-h-16 overflow-auto"
                            title={feature.engineeringComment}
                          >
