...
def seed_database():
    ...
    features_1 = [
        Feature(
            ...
            engineering_comment="OAuth implementation required",
        ...
        Feature(
            ...
            engineering_comment="Need to integrate with email service",
            engineering_signoff=True,
        ...
        Feature(
            ...
            customer_name="Enterprise Sales",
    ...
    features_2 = [
        Feature(
            ...
            customer_name="Data Science Team",
        ...
        Feature(
            ...
            customer_name="Executive Team",
            engineering_comment="Need to implement WebSocket connections",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.L,
    ...
    features_3 = [
        Feature(
            ...
            customer_name="Product Team",
            engineering_comment="Need to implement local storage and sync",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.XL,
        ...
        Feature(
            ...
            customer_name="Marketing Team",
            engineering_comment="Will use Firebase Cloud Messaging",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.M,
            release_date="2023-06",
            assigned_engineer_id=3,
    ...
    features_4 = [
        Feature(
            ...
            engineering_comment="Will integrate with Stripe API",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.L,
            release_date="2023-07",
            assigned_engineer_id=3,
        ...
        Feature(
            ...
            customer_name="Global Sales",
            engineering_comment="Need to implement multiple payment gateways",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.M,
    ...
    features_5 = [
        Feature(
            ...
            customer_name="UX Team",
            engineering_comment="Will use server-side processing",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.M,
            release_date="2023-06",
            assigned_engineer_id=3,
        ...
        Feature(
            ...
            customer_name="Engineering",
            engineering_comment="Will require significant refactoring",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.L,
            release_date="2023-07",
            assigned_engineer_id=3,
    ...
    features_6 = [
        Feature(
            ...
            customer_name="Enterprise Customers",
            engineering_comment="Complex permission system required",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.XL,
            release_date="2023-08",
            assigned_engineer_id=3,
        ...
        Feature(
            ...
            customer_name="Project Managers",
            engineering_comment="Will need to implement activity logging system",
            engineering_signoff=True,
            engineering_complexity=TShirtSize.M,
            release_date="2023-07",
            assigned_engineer_id=3,
